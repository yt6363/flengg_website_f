        ...
        <section className="relative text-center py-20 md:py-32 px-4 overflow-hidden">
          <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 animate-pop-in" style={{ animationDelay: '800ms', opacity: 0 }}>
                  <a href="http://localhost:3001" target="_blank" rel="noopener noreferrer" className="bg-fleng-pink text-white font-bold py-3 px-8 rounded-full text-lg border-4 border-fleng-dark transition-all duration-200 shadow-cartoon hover:shadow-cartoon-hover hover:-translate-y-1 hover:-translate-x-1">
                      Let's Get Started!
                  </a>
                  <a href="#how-it-works" className="bg-white text-fleng-dark font-bold py-3 px-8 rounded-full text-lg border-4 border-fleng-dark transition-all duration-200 shadow-cartoon hover:shadow-cartoon-hover hover:-translate-y-1 hover:-translate-x-1 scroll-smooth">
                      Learn More
                  </a>
              </div>
          </div>
