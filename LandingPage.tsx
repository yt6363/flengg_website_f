    ...
    <>
      ...
      <div className="bg-transparent min-h-screen overflow-hidden font-sans">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="text-left animate-pop-in" style={{ opacity: 0 }}>
                <div className="bg-white border-4 border-Flengg-dark rounded-4xl p-6 md:p-10 shadow-cartoon relative">
                  ...
                  <div className="hidden md:block absolute -right-5 top-1/2 w-0 h-0 border-t-[22px] border-t-transparent border-l-[32px] border-l-Flengg-dark border-b-[22px] border-b-transparent" style={{transform: 'translateY(-50%)'}}></div>
                </div>
              </div>
        ...
        <section className="py-20 px-4 mt-16">
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {/* Custom Challenges */}
              <div className="bg-Flengg-pink border-4 border-Flengg-dark rounded-3xl p-6 shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200 hover:-translate-y-1">
                <div className="flex items-start gap-3 mb-3">
                  <div className="bg-white border-3 border-Flengg-dark rounded-xl p-2 flex-shrink-0">
              ...
              {/* Daily Log Reminders */}
              <div className="bg-Flengg-blue border-4 border-Flengg-dark rounded-3xl p-6 shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200 hover:-translate-y-1">
                <div className="flex items-start gap-3 mb-3">
                  <div className="bg-white border-3 border-Flengg-dark rounded-xl p-2 flex-shrink-0">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
              ...
              {/* Private Profiles */}
              <div className="bg-Flengg-green border-4 border-Flengg-dark rounded-3xl p-6 shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200 hover:-translate-y-1">
                <div className="flex items-start gap-3 mb-3">
                  <div className="bg-white border-3 border-Flengg-dark rounded-xl p-2 flex-shrink-0">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
            ...
            <div className="bg-white border-4 border-Flengg-dark rounded-4xl p-8 md:p-12 shadow-cartoon">
        ...
        <section id="how-it-works" className="py-20 px-4 mt-10 animate-pop-in opacity-0" style={{animationDelay: '200ms'}}>
            <div className="max-w-7xl mx-auto relative z-10">
                <h2 className="text-4xl md:text-5xl font-extrabold text-left mb-12 text-Flengg-dark">How It Works</h2>

                {/* Horizontal Scrolling Cards */}
                <div className="flex gap-6 overflow-x-auto pb-6 scrollbar-hide snap-x snap-mandatory">
                  {/* Card 1 - Create a Challenge */}
                  <div className="flex-shrink-0 w-80 md:w-96 snap-start">
                    <div className="bg-Flengg-blue border-4 border-Flengg-dark rounded-3xl p-6 h-full shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200">
                      <div className="flex items-start gap-4 mb-4">
                        <div className="bg-white border-3 border-Flengg-dark rounded-2xl p-4 flex-shrink-0">
                  ...
                  <div className="flex-shrink-0 w-80 md:w-[500px] snap-start">
                    <div className="bg-Flengg-blue border-4 border-Flengg-dark rounded-3xl p-6 h-full shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200 relative overflow-hidden">
                      ...
                      {/* Speech bubbles */}
                      <div className="absolute bottom-4 right-6 bg-white border-3 border-Flengg-dark rounded-2xl px-3 py-2 text-sm font-bold">Let's go!</div>
                      <div className="absolute bottom-4 left-6 bg-white border-3 border-Flengg-dark rounded-2xl px-3 py-2 text-sm font-bold">I'm in!</div>
                    </div>
                  </div>
                  ...
                  <div className="flex-shrink-0 w-80 md:w-96 snap-start">
                    <div className="bg-Flengg-green border-4 border-Flengg-dark rounded-3xl p-6 h-full shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200 relative overflow-hidden">
                      <div className="text-white mb-4">
                  ...
                  <div className="flex-shrink-0 w-80 md:w-96 snap-start">
                    <div className="bg-Flengg-green border-4 border-Flengg-dark rounded-3xl p-6 h-full shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200">
                      <div className="text-white mb-4">
        ...
        <section className="py-20 px-4 animate-pop-in opacity-0" style={{animationDelay: '300ms'}}>
            <div className="max-w-4xl mx-auto relative z-10 text-center">
                <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-6 text-Flengg-dark">Why We Built Flengg</h2>
                <div className="bg-white border-4 border-Flengg-dark rounded-4xl p-8 md:p-12 shadow-cartoon">
                    <p className="text-xl md:text-2xl text-Flengg-muted font-bold leading-relaxed">
                        Born from a desperate need for accountability (and a love for silly competitions),
                        Flengg is here to make habits stick – with a smile! We believe that goals shouldn't
        ...
        {/* FAQ Section */}
        <section className="py-20 px-4 bg-Flengg-bg mt-10 animate-pop-in opacity-0" style={{animationDelay: '400ms'}}>
            <div className="max-w-4xl mx-auto relative z-10">
                <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-12 text-Flengg-dark">FAQ (Frequently Amusing Questions)</h2>
                <div className="space-y-6">
                    <div className="bg-white border-4 border-Flengg-dark rounded-3xl p-6 md:p-8 shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200">
                        <h3 className="text-2xl font-extrabold text-Flengg-dark mb-3">Q: Will Flengg make me instantly productive and wise?</h3>
                        <p className="text-lg text-Flengg-muted font-bold">A: Probably not, but you'll have fun trying! (And maybe you'll accidentally build a habit or two along the way.)</p>
                    </div>
                    <div className="bg-white border-4 border-Flengg-dark rounded-3xl p-6 md:p-8 shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200">
                        <h3 className="text-2xl font-extrabold text-Flengg-dark mb-3">Q: Can I challenge my cat?</h3>
                        <p className="text-lg text-Flengg-muted font-bold">A: We don't recommend it, but if you succeed, please send us pictures! Our lawyers would also like a word.</p>
                    </div>
                    <div className="bg-white border-4 border-Flengg-dark rounded-3xl p-6 md:p-8 shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200">
                        <h3 className="text-2xl font-extrabold text-Flengg-dark mb-3">Q: Is this app suitable for serious goals?</h3>
                        <p className="text-lg text-Flengg-muted font-bold">A: Absolutely! We're silly, but we're serious about helping you succeed. Whether it's fitness, reading, or learning – Flengg has your back.</p>
                    </div>
                    <div className="bg-white border-4 border-Flengg-dark rounded-3xl p-6 md:p-8 shadow-cartoon hover:shadow-cartoon-hover transition-all duration-200">
                        <h3 className="text-2xl font-extrabold text-Flengg-dark mb-3">Q: What if I miss a day?</h3>
                        <p className="text-lg text-Flengg-muted font-bold">A: No judgment here! Life happens. Jump back in whenever you're ready – your friends will cheer you on. (Or gently roast you. It's part of the fun!)</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        {/* CTA Section */}
        <section className="bg-Flengg-blue text-center py-20 px-4 mt-10 border-y-4 border-Flengg-dark animate-pop-in opacity-0" style={{animationDelay: '500ms'}}>
          ...
          <a href="https://Flengg.vercel.app/" target="_blank" rel="noopener noreferrer" className="bg-white text-Flengg-pink font-bold py-3 px-10 rounded-full text-xl border-4 border-Flengg-dark transition-all duration-200 shadow-cartoon hover:shadow-cartoon-hover hover:scale-105 hover:-translate-y-1 hover:-translate-x-1 transform inline-block">
              Let's Do This!
          </a>
        </section>
        ...
        <footer className="bg-transparent text-center py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-4 md:gap-6 mb-8">
              <a href="https://www.linkedin.com/in/yashwanthsaitatineni/" target="_blank" rel="noopener noreferrer" className="w-14 h-14 md:w-12 md:h-12 bg-blue-600 rounded-full border-4 border-Flengg-dark flex items-center justify-center text-white text-2xl md:text-xl transition-all duration-200 shadow-cartoon hover:shadow-cartoon-hover hover:-translate-y-1 hover:-translate-x-1" aria-label="LinkedIn">
                💼
              </a>
              <a href="mailto:yashnam15@gmail.com" className="w-14 h-14 md:w-12 md:h-12 bg-Flengg-dark rounded-full border-4 border-Flengg-dark flex items-center justify-center text-white text-2xl md:text-xl transition-all duration-200 shadow-cartoon hover:shadow-cartoon-hover hover:-translate-y-1 hover:-translate-x-1" aria-label="Email">
                ✉️
              </a>
            </div>

            {/* Links */}
            <div className="flex flex-wrap justify-center gap-6 mb-6 text-Flengg-muted font-bold">
              <a href="#" className="hover:text-Flengg-pink transition-colors duration-200">Privacy Policy</a>
              <span>•</span>
              <a href="#" className="hover:text-Flengg-pink transition-colors duration-200">Terms of Service</a>
              <span>•</span>
              <a href="#" className="hover:text-Flengg-pink transition-colors duration-200">Contact Us</a>
              <span>•</span>
              <a href="#" className="hover:text-Flengg-pink transition-colors duration-200">Support</a>
            </div>

            {/* Tagline */}
            <p className="text-2xl font-extrabold text-Flengg-dark mb-2">
              Flengg: Making habits less 'meh' and more 'YAY!'
            </p>

            {/* Copyright */}
            <p className="text-Flengg-muted font-bold">
              &copy; {new Date().getFullYear()} Flengg. Keep the streak alive. ✨
            </p>
          </div>
        </footer>
      </div>
